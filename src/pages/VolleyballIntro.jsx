...
const VolleyballIntro = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: "url('public/ball-1930191_1280.jpg')", // Replace with your volleyball image path
      }}
    >
      {/* Overlay */}
      ...
      >
        ...
        <h1 className="text-5xl sm:text-6xl font-extrabold tracking-tight leading-tight mb-6 drop-shadow-lg">
          Inter-College Volleyball Clash 2025
        </h1>

        <p className="text-lg sm:text-xl text-gray-300 font-medium mb-8 leading-relaxed drop-shadow-sm">
          Dive, spike, and rally your way to glory! Join the fiercest volleyball competition where only the best rise above the net.
        </p>

        <button className="bg-gradient-to-r from-yellow-400 to-pink-500 hover:from-yellow-300 hover:to-pink-400 text-black font-bold px-8 py-3 rounded-full shadow-2xl transition duration-300">
          🏐 Register Your Team
        </button>
      </div>
    </section>
...
export default VolleyballIntro;
